...
import com.twt.scan.scanactivity.DataViewModel.DOING_ACTIVITY
import com.twt.scan.scanactivity.DataViewModel.FINISHED_ACTIVITY
import com.twt.scan.scanactivity.DataViewModel.MANAGER_ACTIVITY
import com.twt.scan.scanactivity.DataViewModel.homeBeanJoinedLiveData
...
object DataViewModel : ViewModel() {
    ...
    private fun getDataBean(type:Int){
        GlobalScope.launch(Dispatchers.Main + QuietCoroutineExceptionHandler) {
            val result = ScanActivityApi.getActivities(1, 20, CommonPreferences.token, type).await()
